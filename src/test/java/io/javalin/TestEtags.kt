...
class TestEtags {
    ...
    @Test
    fun test_autogenerated_etags_work_get() = TestUtil.test(etagsEnabledApp, { app, http ->
    ...
    @Test
    fun test_autogenerated_etags_dont_affect_put() = TestUtil.test(etagsEnabledApp, { app, http ->
    ...
    @Test
    fun test_manual_etags_are_preferred() = TestUtil.test(etagsEnabledApp, { app, http ->
    ...
    @Test
    fun test_manual_etags_work_put() = TestUtil.test({ app, http ->
    ...
    @Test
    fun test_no_etags_work() = TestUtil.test({ app, http ->
