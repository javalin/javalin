...
class TestEtags {
    ...
    @Test
    fun test_autogenerated_etags_work_get() = TestUtil(etagsEnabledApp).test { app, http ->
    ...
    @Test
    fun test_autogenerated_etags_dont_affect_put() = TestUtil(etagsEnabledApp).test { app, http ->
    ...
    @Test
    fun test_manual_etags_are_preferred() = TestUtil(etagsEnabledApp).test { app, http ->
