...
public class TestRouting extends _SimpleClientBaseTest {
    ...
    public void test_paramAndSplat() throws Exception {
        ...
        SimpleHttpClient.TestResponse response = simpleHttpClient.http_GET(origin + "/param/path/splat");
    ...
    public void test_encodedParam() throws Exception {
        ...
        SimpleHttpClient.TestResponse response = simpleHttpClient.http_GET(origin + "/" + URLEncoder.encode(paramValue, "UTF-8"));
    ...
    public void test_encdedParamAndEncodedSplat() throws Exception {
        app.get("/:param/path/*", (req, res) -> res.body(req.param("param") + req.splat(0)));
        SimpleHttpClient.TestResponse response = simpleHttpClient.http_GET(
            origin + "/"
    ...
    public void test_caseSensitive_paramName() throws Exception {
        app.get("/:ParaM", (req, res) -> res.body(req.param("pArAm")));
        SimpleHttpClient.TestResponse response = simpleHttpClient.http_GET(origin + "/param");
    ...
    public void test_caseSensitive_paramValue() throws Exception {
        app.get("/:param", (req, res) -> res.body(req.param("param")));
        SimpleHttpClient.TestResponse response = simpleHttpClient.http_GET(origin + "/SomeCamelCasedValue");
