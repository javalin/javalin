...
public class TestMultipleInstances {
    ...
    public static void setup() throws IOException {
        app1 = Javalin.Companion.create().port(7001).start().awaitInitialization();
        app2 = Javalin.Companion.create().port(7002).start().awaitInitialization();
        app3 = Javalin.Companion.create().port(7003).start().awaitInitialization();
    }
