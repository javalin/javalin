...
public class Javalin {
    ...
    protected boolean exceptionOnRequestCacheIsSmall = false;
    ...
    public JavalinServlet createServlet() {
        return new JavalinServlet(
            ...
            exceptionOnRequestCacheIsSmall
        );
    }
    ...
    /**
     * Configure instance to throw exception if request body size larger than maxRequestCacheBodySize.
     * The default value is false.
     * The method must be called before {@link Javalin#start()}.
     */
    public Javalin enableRequestTooLongException() {
        ensureActionIsPerformedBeforeServerStart("Enable RequestTooLong Exception");
        this.exceptionOnRequestCacheIsSmall = true;
        return this;
    }
