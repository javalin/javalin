...
public class Javalin {
    ...
    private boolean lowerCasePaths = true;
    ...
    private WsPathMatcher wsPathMatcher = new WsPathMatcher(lowerCasePaths);
     ...
     * The method must be called before {@link Javalin#start()}.
     */
    public Javalin disableLowerCasePaths() {
    ...
    private Javalin addHandler(@NotNull HandlerType handlerType, @NotNull String path, @NotNull Handler handler, @NotNull Set<Role> roles) {
        ...
        pathMatcher.getHandlerEntries().get(handlerType).add(new HandlerEntry(handlerType, prefixedPath, protectedHandler, handler,lowerCasePaths));
    ...
    public Javalin ws(@NotNull String path, @NotNull Consumer<WsHandler> ws) {
        ...
        wsPathMatcher.getWsEntries().add(new WsEntry(prefixedPath, configuredWebSocket,lowerCasePaths));
