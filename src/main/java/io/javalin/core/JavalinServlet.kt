...
class JavalinServlet(
        ...
        val requestTooLongExceptionEnabled: Boolean,
    ...
    fun service(servletRequest: HttpServletRequest, res: HttpServletResponse) {
        ...
        val req = CachedRequestWrapper(servletRequest, maxRequestCacheBodySize, requestTooLongExceptionEnabled) // cached for reading multiple times
