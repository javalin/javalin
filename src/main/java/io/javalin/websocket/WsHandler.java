...
public class WsHandler {
  ...
  /**
   * Add a WsConnectHandler to the WsHandler. The handler is called when a WebSocket client
   * connects.
   */
  ...
  /**
   * Add a WsMessageHandler to the WsHandler. The handler is called when a WebSocket client sends a
   * String message.
   */
  ...
  /**
   * Add a {@link WsBinaryMessageHandler} to the WsHandler. The handler is called when a WebSocket
   * client sends a binary message.
   */
  ...
  /**
   * Add a WsCloseHandler to the WsHandler. The handler is called when a WebSocket client closes the
   * connection. The handler is not called in case of network issues, only when the client actively
