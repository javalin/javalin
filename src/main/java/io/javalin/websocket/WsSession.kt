 ...
 */
class WsSession(val id: String, session: Session, private var pathParamMap: Map<String, String>, private val matchedPath: String, private val caseSensitiveUrls:Boolean) : Session {
