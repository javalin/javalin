...
import io.javalin.micrometer.MicrometerPlugin.Companion.MicrometerPlugin as MicrometerPluginDsl
...
class MicrometerPluginTest {
    ...
    fun `test that JettyConnectionMetrics is registered`() {
        ...
        val micrometerApp = Javalin.create { cfg -> cfg.registerPlugin(MicrometerPluginDsl) { it.registry = registry } }
    ...
    private fun setupApp(
        ...
        config.registerPlugin(MicrometerPluginDsl) {
