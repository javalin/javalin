...
//    }
    ...
    // For completeness, you may add this convenient version for String based path setup (But property based is better)
    @JvmStatic fun externalRootDirectory(path: String) { rootDirectory = Paths.get(path) }
