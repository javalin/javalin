...
import org.eclipse.jetty.websocket.api.Frame.CloseStatus
...
abstract class WsContext(private val sessionId: String, @JvmField val session: Session) {
    ...
    fun closeSession(closeStatus: CloseStatus): Unit = session.close(closeStatus.code, closeStatus.reason, Callback.NOOP)
