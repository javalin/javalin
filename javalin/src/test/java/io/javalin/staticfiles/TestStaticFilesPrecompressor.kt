...
class TestStaticFilesPrecompressor {
    ...
    private fun Response.contentLength() = this.headers.get(Header.CONTENT_LENGTH.name)
    private fun Response.contentEncoding() = this.headers.get(Header.CONTENT_ENCODING.name)
