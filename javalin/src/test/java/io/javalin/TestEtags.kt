...
class TestEtags {
    ...
    @Test
    fun `autogenerated etags work for input stream response`() = TestUtil.test(etagsEnabledApp) { app, http ->
        app.get("/inputStreamResult") { ctx -> ctx.result(javaClass.getResourceAsStream("/public/file")) }
